...
We found the census data online and map the Berkeley population in block groups.
![](mygraphic.png)
...
## MAP 2: BPD Stop Contour Map of Berkeley by Age Range
...
stop_time_percentage <- ggplot(stop_by, aes(x = Hour, fill = AgeRange)) + 
  ...
  labs(y = "Count") +
  facet_wrap(~Race)+
  labs(title = "Count of person recorded of each race in each hour")
stop_time_percentage
```


## MAP 3: BPD Stop Contour Map of Berkeley by Race
