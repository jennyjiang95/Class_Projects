...
xml_find_all(links, "/document/linkList[@name = 'A']")
...
xml_find_all(jobs, "/jobs/job[@priority='critical' or @prioprity ='high']")
...
xml_find_all(person, "/persons/person[@age >'25']")
```
...
```{r}
xml_find_all(bookstore,"/bookstore/book/pages/../title")
xml_find_all(bookstore,"//book[pages]/title")
```
