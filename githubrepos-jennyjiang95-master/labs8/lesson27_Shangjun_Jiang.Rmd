...
map(.x(loop over this), .f,(function to apply) ...(other argument to f))
...
planes[,c(2,8)] %>% 
  map_dbl(quantile, probs= 0.05,na.rm=T)

#quantile(planes["year"],0.05, na.rm=T)
